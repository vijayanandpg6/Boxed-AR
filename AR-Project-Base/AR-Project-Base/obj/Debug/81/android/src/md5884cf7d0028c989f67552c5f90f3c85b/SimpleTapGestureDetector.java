...
public class SimpleTapGestureDetector
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AR_Project_Base.SimpleTapGestureDetector, AR-Project-Base", SimpleTapGestureDetector.class, __md_methods);
	}


	public SimpleTapGestureDetector ()
	{
		super ();
		if (getClass () == SimpleTapGestureDetector.class)
			mono.android.TypeManager.Activate ("AR_Project_Base.SimpleTapGestureDetector, AR-Project-Base", "", this, new java.lang.Object[] {  });
	}
